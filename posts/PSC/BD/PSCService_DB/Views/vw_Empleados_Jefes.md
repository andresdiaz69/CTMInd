...
SELECT docEmpleado, nombreEmpleado, correoEmpleado, docJefe, nombreJefe, correoJefe
FROM(
	SELECT docEmpleado=a.Documento, nombreEmpleado=a.nombre, correoEmpleado=a.Email_Corporativo, docJefe= d.CC_Jefe1, 
	nombreJefe=e.nombre , correoJefe=e.Email_Corporativo
	FROM(
