# Stored Procedure: rs_gth_gth150_b_PE
...
-- Description:	Visita Domiciliaria Candidato - Planta
-- =============================================

CREATE PROCEDURE [dbo].[rs_gth_gth150_b_PE]
	 @cod_cia		CHAR(3),
	 @cod_conv      VARCHAR(15),
	 @cod_resp		CHAR(12),
	 @num_req       INT,
...
BEGIN
	...
	WHERE	V.cod_cia LIKE RTRIM(@cod_cia) AND V.cod_conv LIKE RTRIM(@cod_conv)
			...
			AND V.cod_cli IS NULL AND EEP.num_ent = @num_vis AND EE.cod_ori = '11';
END
