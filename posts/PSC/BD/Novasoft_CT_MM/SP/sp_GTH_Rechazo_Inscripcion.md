# Stored Procedure: sp_GTH_Rechazo_Inscripcion
...
-- Description: Rechazo proceso Inscripción a un evento
-- ======================================================================
CREATE PROCEDURE [dbo].[sp_GTH_Rechazo_Inscripcion]
	@cod_ale	INT,
	@DTNuevo	XML, 
	@DTAnterior XML
...
BEGIN
	...
	SET @sMsg  = @sMsg + 'Informamos que su inscripción a la capacitación ' +  @nom_even ;	
