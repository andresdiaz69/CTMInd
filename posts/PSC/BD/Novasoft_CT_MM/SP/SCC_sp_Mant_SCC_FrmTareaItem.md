# Stored Procedure: SCC_sp_Mant_SCC_FrmTareaItem
...
--Exec SCC_sp_Mant_SCC_FrmTareaItem (2,16,1,'','','Novasoft\agarcia',2,6,'','20191021','20191021','')
-- =============================================
CREATE PROCEDURE [dbo].[SCC_sp_Mant_SCC_FrmTareaItem]
...
BEGIN
    ...
    BEGIN
	   BEGIN TRY
		  ...
		  INNER JOIN SCC_Tarea_responsable AS TR ON TI.Nro_Formato = TR.Nro_Formato
										    AND TI.Nro_Item = TR.Nro_Item
										    AND TI.Nro_Tarea = TR.Nro_Tarea
