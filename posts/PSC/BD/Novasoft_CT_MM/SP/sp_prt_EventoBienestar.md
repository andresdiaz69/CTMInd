# Stored Procedure: sp_prt_EventoBienestar
...
-- exec sp_prt_EventoBienestar '1018465875','','DatosConfirmarAsistencia'

-- =============================================
CREATE PROCEDURE [dbo].[sp_prt_EventoBienestar]
...
BEGIN
	...
	BEGIN
		...
		FROM GTH_EventoInvita EI
			INNER JOIN v_GTH_EvenBienestar EB ON EI.cod_even = EB.cod_even 
