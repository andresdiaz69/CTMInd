# Stored Procedure: sp_cxp_afecon_local_usu
...
/*Ramiro  6/Marzo/2013 se modifica numero de registro de cuadre de documento 
y se ajusta documento siempre que este dentro del máximo a ajustar   SRS: 2012-0273
SE AGREGA LA CONTABILIZACION DE IMPUESTOS ADICIONALES
JSARMIENTO MAYO/2013 SRS: 2013-0463
SE AGREGA A LA CONTABILIZACION LA BASE AIU SI ES MAYOR DE CERO, DE LO CONTRARIO SE DEJA LA BASE NORMAL DE IMPUESTOS
JSARMIENTO ENERO/2014 SRS: 2014-0089
SE AGREGA LA CUENTA DE ICA DE ACUERDO A PARAMETRO GENERAL (PLANTILLA O ACTIVIDAD)
...
JSARMIENTO NOVIEMBRE/2015 SRS: 2015-0863	
SE ASIGNA LA CUENTA CONTABLE DE GASTO E IVA NO GRAVADO DE ACUERDO A LA DISTRIBUCION DE COSTOS CUANDO NO HAY DISTRIBUCION CONTABLE, 
...
CREATE PROCEDURE [dbo].[sp_cxp_afecon_local_usu]
	@ano_doc	CHAR(4),
	@per_doc	CHAR(2),
	@sub_tip	CHAR(5),
	@num_doc	CHAR(14),
...
BEGIN
	...
	CREATE TABLE	#t_afecon_p (recno		INT IDENTITY(1,1),
	...
	-- Creación de tabla temporal con la misma estructura de Cxp_inf_con
	SELECT * 
		INTO #Cxp_inf_con 
	FROM Cxp_inf_con 
	WHERE ano_doc='??' 
	...
	SELECT @wind_tip=tip_pro,@wcxp=cod_cta, @nit_pro=nce,@cta_taspac=cta_taspac, @cta_sum1=cta_imp_sum1 , @cta_sum2=cta_imp_sum2 , @cta_sum3=cta_imp_sum3 , @cta_sum4=cta_imp_sum4 
				, @cta_res1=cta_imp_res1 , @cta_res2=cta_imp_res2 , @cta_res3=cta_imp_res3 , @cta_res4=cta_imp_res4 
	FROM cxp_provee 
	...
	BEGIN
		...
		BEGIN
			...
			INSERT INTO @afecon_p(cod_pro,cod_suc,cod_cco,ind_con,cod_cl1,cod_cl2,cod_cl3,ind_afe,tip_ret,por_iva,net_doc,val_iva,
							val_ret,val_doc,ant_doc,val_des,sub_doc,val_ica,ret_iva,val_tim,val_iva_ng,bas_rii,bas_rti
							,ret_riv_ng,mon_sum1,mon_sum2,mon_sum3,mon_sum4,mon_res1,mon_res2,mon_res3,mon_res4,base_iva_aiu,cod_ica)
			SELECT cod_pro,cod_suc,cod_cco,ind_con,cod_cl1,cod_cl2,cod_cl3,Ind_afe,tip_ret,por_iva,SUM(net_doc),SUM(val_iva),
						SUM(val_ret),SUM(val_doc),SUM(ant_doc),SUM(val_des),SUM(sub_doc),SUM(val_ica),SUM(ret_iva),SUM(val_tim),SUM(val_iva_ng),SUM(bas_rii),SUM(bas_rti)
						,SUM(ret_riv_ng),SUM(mon_sum1),SUM(mon_sum2),SUM(mon_sum3),SUM(mon_sum4),SUM(mon_res1),SUM(mon_res2),SUM(mon_res3),SUM(mon_res4)
						,SUM(base_iva_aiu),cod_ica
			...
			BEGIN
				SELECT @cod_pro=cod_pro,@cod_suc=cod_suc,@cod_cco=cod_cco,@ind_con=ind_con,@cod_cl1=cod_cl1,@cod_cl2=cod_cl2,@cod_cl3=cod_cl3,@ind_afe=ind_afe,
							...
							@base_aiu=base_iva_aiu,@cod_ica=cod_ica
				FROM @afecon_p
				WHERE recno=@conta5;
				...
				IF @niv_dist = 5
				BEGIN
					SELECT @dcta_gas = cta_gas, @dcta_ivang=cta_ivang
				...
				BEGIN
					SELECT @wcxp=fa_cxp,@cta_taspac=cxp_taspac 
					FROM cxp_param_cnt 
					WHERE llave=@ind_con;
				END;

				EXEC sp_gen_trae_tasa @wcxp, @fec_tas, @tasa OUTPUT, @ind_mp;
				...
				IF @Val_doc>0
				BEGIN
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, fch_doc, cod_cta, cod_suc, cod_cco, cod_cl1, 
										cod_cl2, cod_cl3, cod_ter, deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc, @wcxp, @cod_suc,@cod_cco,@cod_cl1,@cod_cl2,
				...
				BEGIN
					...
					EXEC sp_gen_trae_tasa @wriv, @fec_tas, @tasa OUTPUT, @ind_mp;
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc,fch_doc, cod_cta, cod_suc, cod_cco, cod_cl1, 
										cod_cl2, cod_cl3, cod_ter, deb_mov, cre_mov, des_mov,bas_mov,num_che,ind_cos,ind_tra,ind_mr,fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@wriv,@cod_suc,@cod_cco,@cod_cl1,@cod_cl2,
								@cod_cl3,@nit_pro,0,@ret_iva,LEFT(RTRIM(@des_mov)+' Retención de Iva',60),@base,@num_che,'','',@ind_mp,@fec_tas,@tasa,@ind_tas,0);
					SET @wreg=@wreg+1;

					IF @wind_tip=3
					BEGIN
						SELECT @wriv=fa_iva_pag 
						FROM cxp_param_cnt 
						WHERE llave=@ind_con;
				...
				BEGIN
					SELECT @wriv_ng=fa_iva_ret_sim 
					FROM cxp_param_cnt 
					WHERE llave=@ind_con;

					EXEC sp_gen_trae_tasa @wriv_ng, @fec_tas, @tasa OUTPUT, @ind_mp;
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc,fch_doc, cod_cta, 
					...
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@wriv_ng,
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc,sub_tip,tip_doc,num_doc,reg_doc,fch_doc,cod_cta,cod_suc,cod_cco,cod_cl1,
									cod_cl2,cod_cl3,cod_ter,deb_mov,cre_mov,des_mov,bas_mov,num_che,ind_cos,ind_tra,ind_mr,fec_tas,tasa,ind_tas,difcam_doc)
					VALUES(@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@wriv_ng,@cod_suc,@cod_cco,@cod_cl1,@cod_cl2,
				...
				IF @val_ica>0
				BEGIN
					SELECT @wica=fa_ica_ret 
					FROM cxp_param_cnt 
					WHERE llave=@ind_con;
				
					IF @ind_cta_ica = 2
					BEGIN
						SELECT @wica=cod_cta_com
						FROM gen_actividad
					...
					EXEC sp_gen_trae_tasa @wica, @fec_tas, @tasa OUTPUT, @ind_mp;
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
					...
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@wica, 
				...
				BEGIN
					...
					EXEC sp_gen_trae_tasa @wret, @fec_tas, @tasa OUTPUT, @ind_mp;
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
									...
									deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
									fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@wret, 
				...
				BEGIN
					...
					EXEC sp_gen_trae_tasa @wiva, @fec_tas, @tasa OUTPUT, @ind_mp;
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
									...
									deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
									fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@wiva, 
				...
				BEGIN
					...
					BEGIN
						IF @dcta_ivang <> '0'
						BEGIN	
							EXEC sp_gen_trae_tasa @dcta_ivang, @fec_tas, @tasa OUTPUT, @ind_mp;
							...
							INSERT INTO #Cxp_inf_con (	ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc,fch_doc, cod_cta, 
																	cod_suc, cod_cco, cod_cl1, cod_cl2, cod_cl3, cod_ter, deb_mov, 
																	cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, fec_tas, tasa, ind_tas,difcam_doc)
							VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@dcta_ivang, 
						...
						ELSE
						BEGIN
							SELECT @wivang=fa_iva_ng 
							FROM cxp_param_cnt 
							WHERE llave=@ind_con;

							EXEC sp_gen_trae_tasa @wivang, @fec_tas, @tasa OUTPUT, @ind_mp;
							...
							INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
											...
											deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
											fec_tas, tasa, ind_tas,difcam_doc)
							VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@wivang, 
										@cod_suc,@cod_cco,@cod_cl1,@cod_cl2,@cod_cl3,@nit_pro, @val_iva_ng, 
										0,LEFT(RTRIM(@des_mov),70), @base_cnt,@num_che,'','', @ind_mp, @fec_tas, @tasa, @ind_tas,0);
					...
					BEGIN
						...
						SELECT cta_ivang, Cod_suc, Cod_cco, Cod_cl1, Cod_cl2, Cod_cl3, ROUND((Porcentaje/100)*@val_iva_ng,@num_dec) AS valor,ROUND((Porcentaje/100)*@base_cnt,@num_dec) AS base
						FROM Cxp_distriafe 
						...
						BEGIN
							...
							INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
											...
											deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
											fec_tas, tasa, ind_tas,difcam_doc)
							VALUES (@ano_doc, @per_doc, @sub_tip, @tip_doc, @num_doc,CONVERT(CHAR,@wreg), 
				...
				IF @val_tim>0
				BEGIN
					SELECT @fa_tim=fa_tim 
					FROM cxp_param_cnt 
					WHERE llave=@ind_con;

					EXEC sp_gen_trae_tasa @fa_tim, @fec_tas, @tasa OUTPUT, @ind_mp;
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
									...
									deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
									fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@fa_tim, 
				...
				BEGIN
					...
					EXEC sp_gen_trae_tasa @wdes, @fec_tas, @tasa OUTPUT, @ind_mp;
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
										...
										deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
										fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@wdes, 
				...
				BEGIN
					...
					BEGIN
						...
						EXEC sp_gen_trae_tasa @want, @fec_tas, @tasa OUTPUT, @ind_mp;
						...
						INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
										...
										deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
										fec_tas, tasa, ind_tas,difcam_doc)
						VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@want, 
						...
						INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
										...
										deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
										fec_tas, tasa, ind_tas,difcam_doc)
						VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@wcxp, 
				...
				BEGIN
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
								...
								deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
								fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@cta_sum1, 
				...
				BEGIN
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
									...
									deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
									fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@cta_sum2, 
				...
				BEGIN
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
										...
										deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
										fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@cta_sum3, 
				...
				BEGIN
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
										...
										deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
										fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@cta_sum4, 
				...
				BEGIN
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
										...
										deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
										fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@cta_res1, 
				...
				BEGIN
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
									...
									deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
									fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@cta_res2, 
				...
				BEGIN
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
									...
									deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
									fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@cta_res3, 
				...
				BEGIN
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
									...
									deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
									fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@cta_res4, 
				...
				BEGIN
					...
					BEGIN
						IF @dcta_gas <>'0'
						BEGIN
							EXEC sp_gen_trae_tasa @dcta_gas, @fec_tas, @tasa OUTPUT, @ind_mp;
							...
							INSERT INTO #Cxp_inf_con (	ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, fch_doc, cod_cta, 
																	...
																	bas_mov, num_che, ind_cos, ind_tra, ind_mr, fec_tas, tasa, ind_tas,difcam_doc)
							VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@dcta_gas, 
						...
						BEGIN
							...
							INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
											...
											deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
											fec_tas, tasa, ind_tas,difcam_doc)
							VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@wven, 
										@cod_suc,@cod_cco,@cod_cl1,@cod_cl2,@cod_cl3,@nit_pro, @net_doc, 0,LEFT(RTRIM(@des_mov),60), 
										@sub_doc,@num_che,'','', @ind_mp, @fec_tas, @tasa, @ind_tas,0);
				...
				BEGIN
					...
					SELECT Cod_cta, Cod_suc, Cod_cco, Cod_cl1, Cod_cl2, Cod_cl3, ROUND((Porcentaje/100)*@Net_doc,@num_dec) AS valor, ROUND((Porcentaje/100)*@sub_doc,@num_dec) AS base
					FROM Cxp_distriafe 
					WHERE Cod_afe= @Ind_afe;
					...
					SELECT @conta9=ISNULL(COUNT(1),0) FROM #t_afecon_p;

					SELECT @conta8=MIN(recno) FROM #t_afecon_p;
					SELECT @conta9=MAX(recno) FROM #t_afecon_p;
		...
		BEGIN
			...
			SELECT cod_pro,cod_suc,cod_cco,ind_con,cod_cl1,cod_cl2,cod_cl3,Ind_afe,SUM(net_doc),SUM(val_iva),
						...
						SUM(base_iva_aiu),SUM(mon_sum1),SUM(mon_sum2),SUM(mon_sum3),SUM(mon_sum4),SUM(mon_res1),SUM(mon_res2),SUM(mon_res3),SUM(mon_res4),cod_ica,tip_ret,
			...
			BEGIN
				...
				SELECT @ind_adc=ind_adc, @nat_cta = nat_cta, @cta_idc = cta_idc, @cta_gdc = cta_gdc  
				FROM cnt_puc 
				WHERE cod_cta=@wcxp;
					...
					BEGIN
						...
						BEGIN
							...
							BEGIN
								...
								INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc,fch_doc, 
				...
				BEGIN
					IF @wind_tip=3
					BEGIN
						SELECT @wriv=ce_iva_ret_sim 
						FROM cxp_param_cnt 
						WHERE llave=@ind_con;
					END;
					ELSE
					BEGIN
						SELECT @wriv=ce_iva_ret 
						FROM cxp_param_cnt 
						WHERE llave=@ind_con;
					END;
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, 
									...
									deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
									fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@wriv, 
				...
				BEGIN
					...
					EXEC sp_gen_trae_tasa @wmen,@fec_tas,@tasa OUTPUT,@ind_mp;
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc,
									...
									deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, 
									fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@wmen,
				...
				BEGIN
					...
					EXEC sp_gen_trae_tasa @wmay,@fec_tas,@tasa OUTPUT,@ind_mp;
					...
					INSERT INTO #Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc,
									...
									deb_mov, cre_mov, des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr,
									fec_tas, tasa, ind_tas,difcam_doc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@wmay,
		...
		BEGIN
			INSERT INTO @afecon_p(cod_pro,cod_suc,cod_cco,ind_con,cod_cl1,cod_cl2,cod_cl3,ind_afe,net_doc,val_iva,
								...
								mon_res1,mon_res2,mon_res3,mon_res4,base_iva_aiu,cod_ica)
			SELECT cod_pro,cod_suc,cod_cco,ind_con,cod_cl1,cod_cl2,cod_cl3,Ind_afe,SUM(net_doc),SUM(val_iva),
						...
						SUM(mon_sum1),SUM(mon_sum2),SUM(mon_sum3),SUM(mon_sum4),SUM(mon_res1),SUM(mon_res2),SUM(mon_res3),SUM(mon_res4),SUM(base_iva_aiu),cod_ica
			FROM cxp_cuedoc WITH (NOLOCK)
			WHERE ano_doc=RTRIM(@ano_doc) 
				AND per_doc=RTRIM(@per_doc) 
				AND sub_tip=RTRIM(@sub_tip) 
			...
			BEGIN
				SELECT @cod_pro=cod_pro,@cod_suc=cod_suc,@cod_cco=cod_cco,@ind_con=ind_con,@cod_cl1=cod_cl1,@cod_cl2=cod_cl2,@cod_cl3=cod_cl3,@ind_afe=ind_afe,
							@net_doc=net_doc,@val_iva=val_iva,@val_ret=val_ret,@val_doc=val_doc,@ant_doc=ant_doc,@val_des=val_des,@sub_doc=sub_doc,
							@val_ica=val_ica,@ret_iva=ret_iva,@may_val=may_val,@men_val=men_val,@tip_ret=tip_ret,@val_iva_ng=val_iva_ng,@bas_rii=bas_rii,@bas_rti=bas_rti
							,@ret_riv_ng=ret_riv_ng,@mon_sum1=mon_sum1,@mon_sum2=mon_sum2,@mon_sum3=mon_sum3,@mon_sum4=mon_sum4,@mon_res1=mon_res1,@mon_res2=mon_res2
							,@mon_res3=mon_res3,@mon_res4=mon_res4,@base_aiu=base_iva_aiu,@cod_ica=cod_ica
				FROM @afecon_p
				WHERE recno=@conta5;
				...
				BEGIN
					IF @wind_tip=3
					BEGIN
						SELECT @wriv=nd_iva_ret_sim 
						FROM cxp_param_cnt 
						WHERE llave=@ind_con;
					END;
					ELSE
					BEGIN
						SELECT @wriv=nd_iva_ret 
						FROM cxp_param_cnt 
						WHERE llave=@ind_con;
					END;
				...
				BEGIN
					...
					BEGIN
						...
						BEGIN
							...
							INSERT INTO #Cxp_inf_con (	ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc,fch_doc, cod_cta, 
																	cod_suc, cod_cco, cod_cl1, cod_cl2, cod_cl3, cod_ter, deb_mov, cre_mov, 
																	des_mov, bas_mov, num_che, ind_cos, ind_tra, ind_mr, fec_tas, tasa, ind_tas,difcam_doc)
							VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,CONVERT(CHAR,@wreg),@fch_doc,@dcta_ivang, 
										@cod_suc,@cod_cco,@cod_cl1,@cod_cl2,@cod_cl3,@nit_pro, 0, @val_iva_ng, 
										LEFT(RTRIM(@des_mov),60), @base_cnt,@num_che,'','', @ind_mp, @fec_tas, @tasa, @ind_tas,0);
					...
					BEGIN
						...
						SELECT @conta9=ISNULL(COUNT(1),0) FROM #t_afecon_ng;

						SELECT @conta8=MIN(recno) FROM #t_afecon_ng;

						SELECT @conta9=MAX(recno) FROM #t_afecon_ng;
				...
				-- GASTO
				--	SRS	2011-0432
				--	AGREGAMOS AFECTACION DISTRIBUIDA DEL GASTO EN LAS NOTAS DEBITO
				--	JCESARS
				IF @ind_afe='0'
				BEGIN
					IF @dcta_gas <> '0'
		...
		BEGIN
			...
			BEGIN
				...
				-- BANCOS
				SELECT @wban=an_caj_ban 
				FROM cxp_param_cnt 
				WHERE llave=@ind_con;

				EXEC sp_gen_trae_tasa @wban, @fec_tas, @tasa OUTPUT, @ind_mp;
		...
		BEGIN
			...
			BEGIN
				...
				EXEC sp_gen_trae_tasa @wddc, @fec_tas, @tasa OUTPUT, @ind_mp;
				...
				EXEC sp_gen_trae_tasa @wdcc, @fec_tas, @tasa OUTPUT, @ind_mp;
		...
		BEGIN
			...
			BEGIN
				...
				SELECT @wdcc=che_dcc 
				FROM cxp_param_cnt WHERE llave=@ind_con;
	...
	IF OBJECT_ID('Tempdb..#Cxp_inf_con') IS NOT NULL
	BEGIN
		DELETE Cxp_inf_con
		WHERE ano_doc=RTRIM(@ano_doc) 
			AND per_doc=RTRIM(@per_doc) 
		...
		FROM #Cxp_inf_con AS C 
		INNER JOIN Cnt_puc AS p WITH (NOLOCK) ON c.cod_cta= p.cod_cta;
		...
		INSERT INTO #Cxp_inf_con1 (ano_doc, per_doc, sub_tip, tip_doc, num_doc,cod_cta, cod_suc, cod_cco, cod_cl1, cod_cl2, cod_cl3, 
		...
		INSERT INTO Cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, Reg_doc, cod_cta, cod_suc, cod_cco, cod_cl1, cod_cl2, cod_cl3, 
						deb_mov, cre_mov, fch_doc, cod_ter, ind_tra, des_mov, bas_mov, num_che, ind_cos, ind_mr, fec_tas, tasa, ind_mod, ind_tas,difcam_doc)
		...
		DROP TABLE #Cxp_inf_con;
		DROP TABLE #Cxp_inf_con1;
		...
		BEGIN
			...
			BEGIN
				IF @tot_deb<@tot_cre
				BEGIN
					INSERT INTO cxp_inf_con (ano_doc, per_doc, sub_tip, tip_doc, num_doc, reg_doc, fch_doc, cod_cta, cod_suc, 
