# Stored Procedure: sp_cxc_afecon_local_usu
...
AYVEGA MARZO/2019 SRS2018-0957 SE MODIFICA CUENTA PARA ICA EN LOS INGRESOS*/
CREATE PROCEDURE [dbo].[sp_cxc_afecon_local_usu] 
	@ano_doc	CHAR(4),
	@per_doc	CHAR(2),
	@sub_tip	CHAR(5),
	@num_doc	CHAR(14),
...
BEGIN
	...
	DECLARE @mon_tes		CHAR(2);
	DECLARE @cta_bco		CHAR(16);
	...
	DECLARE @docs	TABLE (cod_suc	CHAR(3) COLLATE DATABASE_DEFAULT,
									...
									cod_ret		VARCHAR(10) COLLATE DATABASE_DEFAULT,
	...
	SELECT @wind_tip=tip_cli,@wcxc=cod_cta,@nit_cli=nit_cli, @cta_sum1=cta_imp_sum1, @cta_sum2=cta_imp_sum2, @cta_sum3=cta_imp_sum3, @cta_sum4=cta_imp_sum4
				, @cta_res1=cta_imp_res1, @cta_res2=cta_imp_res2, @cta_res3=cta_imp_res3, @cta_res4=cta_imp_res4, @cta_autres1=cta_aut_res1, @cta_autres2=cta_aut_res2 , @cta_autres3=cta_aut_res3
				, @cta_autres4=cta_aut_res4, @wcxctaspac=cta_taspac
	FROM cxc_cliente 
	WHERE cod_cli=@cod_cli;

	SELECT @nit_cli=ISNULL(@nit_cli,@cod_cli);
	...
	BEGIN
		...
		BEGIN
			INSERT INTO @docs (cod_suc,cod_cco,cod_cli,ind_con,cod_cl1,cod_cl2,cod_cl3,net_doc,val_iva,val_ret,val_doc,ant_doc,val_des,sub_doc,val_ica,ret_iva,val_tim,
							mon_sum1,mon_sum2,mon_sum3,mon_sum4,mon_res1,mon_res2,mon_res3,mon_res4,base_aiu,cod_ica,cod_ret)
			SELECT cod_suc,cod_cco,cod_cli,ind_con,cod_cl1,cod_cl2,cod_cl3,SUM(net_doc),SUM(val_iva),SUM(val_ret),SUM(val_doc),
					...
					SUM(mon_res1),SUM(mon_res2),SUM(mon_res3),SUM(mon_res4),SUM(base_iva_aiu),cod_ica,cod_ret
			FROM cxc_cuedoc
			...
			BEGIN
				SELECT @cod_suc=cod_suc,@cod_cco=cod_cco,@cod_cli=cod_cli,@ind_con=ind_con,@cod_cl1=cod_cl1,@cod_cl2=cod_cl2,@cod_cl3=cod_cl3,@net_doc=net_doc,
						...
						@base_aiu=base_aiu,@cod_ica=cod_ica,@cod_ret=cod_ret
				FROM @docs
				WHERE recno = @conteo2;
				...
				SELECT @wdes=fa_des,@wret=fa_ret,@ant_ret=fa_ant_ret,@wiva=fa_iva,@fa_tim=fa_tim,@want=fa_ant,@wven=fa_ven 
				FROM cxc_param_cnt 
				WHERE llave=@ind_con;
				...
				IF @ind_cxc=2
				BEGIN
					SELECT @wcxc=fa_cli, @wcxctaspac = cxc_taspac 
					FROM cxc_param_cnt 
					WHERE llave=@ind_con;
				END;

				EXEC sp_gen_trae_tasa @wcxc,@fec_tas,@tasa OUTPUT,@ind_mp;
				...
				BEGIN
					IF @ind_cta_ret = 2
					BEGIN
						SELECT @wret=ISNULL(cta_ret_ven,'0'),@ant_ret=ISNULL(cta_aut_ret,'0') 
						FROM gen_retencion 
					...
					BEGIN
						...
						--ANTICIPO RETENCION
						EXEC sp_gen_trae_tasa @ant_ret,@fec_tas,@tasa OUTPUT,@ind_mp;
						...
						INSERT INTO @cinfon (ano_doc,per_doc,sub_tip,tip_doc,num_doc,reg_doc,fch_doc,cod_cta,
										...
										bas_mov,
										num_che,ind_cos,ind_tra,ind_mr,fec_tas,tasa,ind_tas,ind_adc)
						VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,@wreg,@fch_doc,@ant_ret,
								@cod_suc,
								CASE @i_cco WHEN 1 THEN @cod_cco ELSE '0' END,
								CASE @i_cl1 WHEN 1 THEN @cod_cl1 ELSE '0' END,
								CASE @i_cl2 WHEN 1 THEN @cod_cl2 ELSE '0' END,
				...
				BEGIN
					IF @wind_tip=3
					BEGIN
						SELECT @wriv=fa_iva_des_sim FROM cxc_param_cnt WHERE llave=@ind_con;
					...
					ELSE
					BEGIN
						SELECT @wriv=fa_iva_des FROM cxc_param_cnt WHERE llave=@ind_con;
				...
				BEGIN
					IF @wind_tip<>3
					BEGIN
						SELECT @wica=fa_ica_des FROM cxc_param_cnt WHERE llave=@ind_con;
					...
					ELSE
					BEGIN
						SELECT @wica=fa_ica_cob FROM cxc_param_cnt WHERE llave=@ind_con;
				...
				BEGIN
					...
					INSERT INTO @cinfon (ano_doc,per_doc,sub_tip,tip_doc,num_doc,reg_doc,fch_doc,cod_cta,
									...
									bas_mov,
									num_che,ind_cos,ind_tra,ind_mr,fec_tas,tasa,ind_tas,ind_adc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,@wreg,@fch_doc,@fa_tim,
								@cod_suc,
								CASE @i_cco WHEN 1 THEN @cod_cco ELSE '0' END,
								CASE @i_cl1 WHEN 1 THEN @cod_cl1 ELSE '0' END,
								CASE @i_cl2 WHEN 1 THEN @cod_cl2 ELSE '0' END,
				...
				BEGIN
					...
					EXEC sp_gen_trae_tasa @cta_autres1,@fec_tas,@tasa OUTPUT,@ind_mp;
					...
					INSERT INTO @cinfon (ano_doc,per_doc,sub_tip,tip_doc,num_doc,reg_doc,fch_doc,cod_cta,
									...
									bas_mov,
									num_che,ind_cos,ind_tra,ind_mr,fec_tas,tasa,ind_tas,ind_adc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,@wreg,@fch_doc,@cta_autres1,
								@cod_suc,
								CASE @i_cco WHEN 1 THEN @cod_cco ELSE '0' END,
								CASE @i_cl1 WHEN 1 THEN @cod_cl1 ELSE '0' END,
								CASE @i_cl2 WHEN 1 THEN @cod_cl2 ELSE '0' END,
				...
				BEGIN
					...
					BEGIN
						...
						--ANTICIPO IMPUESTO RESTA 2
						SELECT @i_cco=ind_cco,@i_cl1=ind_cl1,@i_cl2=ind_cl2,@i_cl3=ind_cl3,@i_ter=ind_ter,@i_bas=ind_bas 
						FROM cnt_puc 
						WHERE cod_cta=@cta_autres2;

						EXEC sp_gen_trae_tasa @cta_autres2,@fec_tas,@tasa OUTPUT,@ind_mp;
						...
						INSERT INTO @cinfon (ano_doc,per_doc,sub_tip,tip_doc,num_doc,reg_doc,fch_doc,cod_cta,
										...
										bas_mov,
										num_che,ind_cos,ind_tra,ind_mr,fec_tas,tasa,ind_tas,ind_adc)
						VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,@wreg,@fch_doc,@cta_autres2,
									@cod_suc,
									CASE @i_cco WHEN 1 THEN @cod_cco ELSE '0' END,
									CASE @i_cl1 WHEN 1 THEN @cod_cl1 ELSE '0' END,
									CASE @i_cl2 WHEN 1 THEN @cod_cl2 ELSE '0' END,
				...
				BEGIN
					...
					BEGIN
						...
						--ANTICIPO IMPUESTO RESTA 3
						SELECT @i_cco=ind_cco,@i_cl1=ind_cl1,@i_cl2=ind_cl2,@i_cl3=ind_cl3,@i_ter=ind_ter,@i_bas=ind_bas 
						FROM cnt_puc 
						WHERE cod_cta=@cta_autres3;

						EXEC sp_gen_trae_tasa @cta_autres3,@fec_tas,@tasa OUTPUT,@ind_mp;
						...
						INSERT INTO @cinfon (ano_doc,per_doc,sub_tip,tip_doc,num_doc,reg_doc,fch_doc,cod_cta,
											...
											bas_mov,
											num_che,ind_cos,ind_tra,ind_mr,fec_tas,tasa,ind_tas,ind_adc)
						VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,@wreg,@fch_doc,@cta_autres3,
									@cod_suc,
									CASE @i_cco WHEN 1 THEN @cod_cco ELSE '0' END,
									CASE @i_cl1 WHEN 1 THEN @cod_cl1 ELSE '0' END,
									CASE @i_cl2 WHEN 1 THEN @cod_cl2 ELSE '0' END,
				...
				BEGIN
					...
					BEGIN
						...
						--ANTICIPO IMPUESTO RESTA 4
						SELECT @i_cco=ind_cco,@i_cl1=ind_cl1,@i_cl2=ind_cl2,@i_cl3=ind_cl3,@i_ter=ind_ter,@i_bas=ind_bas 
						FROM cnt_puc 
						WHERE cod_cta=@cta_autres4;

						EXEC sp_gen_trae_tasa @cta_autres4,@fec_tas,@tasa OUTPUT,@ind_mp;
						...
						VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,@wreg,@fch_doc,@cta_autres4,
									@cod_suc,
									CASE @i_cco WHEN 1 THEN @cod_cco ELSE '0' END,
									CASE @i_cl1 WHEN 1 THEN @cod_cl1 ELSE '0' END,
									CASE @i_cl2 WHEN 1 THEN @cod_cl2 ELSE '0' END,
		...
		BEGIN
			...
			BEGIN
				...
				SELECT @des_mov=det_doc,@cod_pai=cod_pai,@cod_dep=cod_dep,@cod_ciu=cod_ciu
				FROM cxc_cabdoc 
				WHERE ano_doc=@ano_doc 
					AND per_doc=@per_doc 
					AND sub_tip=@sub_tip 
				...
				BEGIN
					IF @wind_tip=3
					BEGIN
						SELECT @wriv=ri_iva_des_sim FROM cxc_param_cnt WHERE llave=@ind_con;
					END;
					ELSE
					BEGIN
						SELECT @wriv=ri_iva_des FROM cxc_param_cnt WHERE llave=@ind_con;
					END;
					...
					INSERT INTO @cinfon (ano_doc,per_doc,sub_tip,tip_doc,num_doc,reg_doc,fch_doc,cod_cta,cod_suc,
										...
										bas_mov,
										num_che,ind_cos,ind_tra,ind_mr,fec_tas,tasa,ind_tas,ind_adc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,@wreg,@fch_doc,@wriv,@cod_suc,
								CASE @i_cco WHEN 1 THEN @cod_cco ELSE '0' END,
								CASE @i_cl1 WHEN 1 THEN @cod_cl1 ELSE '0' END,
								CASE @i_cl2 WHEN 1 THEN @cod_cl2 ELSE '0' END,
								CASE @i_cl3 WHEN 1 THEN @cod_cl3 ELSE '0' END,
				...
				IF @val_ica>0
				BEGIN
					SELECT @wica=ri_ica_des FROM cxc_param_cnt WHERE llave=@ind_con;
					...
					INSERT INTO @cinfon (ano_doc,per_doc,sub_tip,tip_doc,num_doc,reg_doc,fch_doc,cod_cta,cod_suc,
									...
									bas_mov,
									num_che,ind_cos,ind_tra,ind_mr,fec_tas,tasa,ind_tas,ind_adc)
					VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,@wreg,@fch_doc,@wica,@cod_suc,
								CASE @i_cco WHEN 1 THEN @cod_cco ELSE '0' END,
								CASE @i_cl1 WHEN 1 THEN @cod_cl1 ELSE '0' END,
								CASE @i_cl2 WHEN 1 THEN @cod_cl2 ELSE '0' END,
								CASE @i_cl3 WHEN 1 THEN @cod_cl3 ELSE '0' END,
				...
				IF @val_ret>0
				BEGIN
					SELECT @wret=ri_ret FROM cxc_param_cnt WHERE llave=@ind_con;
				...
				IF @val_iva>0
				BEGIN
					SELECT @wiva=nc_iva FROM cxc_param_cnt WHERE llave=@ind_con;
				...
				IF @val_des>0
				BEGIN
					SELECT @wdes=ri_des FROM cxc_param_cnt WHERE llave=@ind_con;
				...
				-- CAJA/BANCO
				--	VALIDAMOS QUE EL DOC SEA ORIGEN DE TESORERIA Y LA MONEDA SEA DIFERENTE A LA DEL CLIENTE
				--	PAGOS A CLIENTES EXTRANJEROS CON MONEDA LOCAL
				IF @apl_ori='TES'
				BEGIN
					SELECT @mon_cli=tip_mon FROM cxc_cliente WHERE cod_cli=@cod_cli;
				
					SELECT @mon_tes=a.ind_mp,@cta_bco=b.ctactb 
					FROM tes_cabdoc AS a 
					INNER JOIN tes_bancos AS b ON a.banco=b.bancos
					WHERE ano_doc=@ano_doc 
						AND per_doc=@per_doc 
						AND sub_tip=@sub_tip 
						AND num_doc=@num_doc;
					...
					ELSE
					BEGIN
						SELECT @wven=ri_caj_ban FROM cxc_param_cnt WHERE llave=@ind_con;
					END;
				END;
				ELSE
				BEGIN
				...
				IF @men_val>0
				BEGIN
					SELECT @wmen=ri_otr_des FROM cxc_param_cnt WHERE llave=@ind_con;
				...
				IF @may_val>0
				BEGIN
					SELECT @wmay=ri_otr_ing FROM cxc_param_cnt WHERE llave=@ind_con;
				...
				IF @val_int>0
				BEGIN
					SELECT @cta_int=ri_cta_int FROM cxc_param_cnt WHERE llave=@ind_con;
		...
		BEGIN
			INSERT INTO @docs(cod_suc,cod_cco,cod_cli,ind_con,cod_cl1,cod_cl2,cod_cl3,net_doc,val_iva,val_ret,val_doc,ant_doc,val_des,sub_doc,val_ica,
								ret_iva,men_val,may_val,mon_sum1,mon_sum2,mon_sum3,mon_sum4,mon_res1,mon_res2,mon_res3,mon_res4,base_aiu,cod_ica,cod_ret)
			SELECT cod_suc,cod_cco,cod_cli,ind_con,cod_cl1,cod_cl2,cod_cl3,SUM(net_doc),SUM(val_iva),SUM(val_ret),SUM(val_doc),
			...
			BEGIN
				...
				BEGIN
					IF @wind_tip=3
					BEGIN
						SELECT @wriv=nc_iva_des_sim 
						FROM cxc_param_cnt 
						WHERE llave=@ind_con;
					END;
					ELSE
					BEGIN
						SELECT @wriv=nc_iva_des 
						FROM cxc_param_cnt 
						WHERE llave=@ind_con;
					END;
				...
				BEGIN
					IF @wind_tip<>3
					BEGIN
						SELECT @wica=nc_ica_des FROM cxc_param_cnt WHERE llave=@ind_con;
					...
					BEGIN
						...
						SELECT @wica=nc_ica_cob FROM cxc_param_cnt WHERE llave=@ind_con;
				...
				BEGIN
					...
					IF @ind_aut=1
					BEGIN
						SELECT @wret=nc_ret,@ant_ret=fa_ant_ret  FROM cxc_param_cnt WHERE llave=@ind_con;
				...
				IF @val_des>0
				BEGIN
					SELECT @wdes=nc_des FROM cxc_param_cnt WHERE llave=@ind_con;
				...
				-- VENTA
				SELECT @wven=nc_ven FROM cxc_param_cnt WHERE llave=@ind_con;
		...
		BEGIN
			...
			BEGIN
				...
				-- BANCOS
				SELECT @wban=an_caj_ban FROM cxc_param_cnt WHERE llave=@ind_con;
				...
				-- ANTICIPOS
				SELECT @want=an_ant FROM cxc_param_cnt WHERE llave=@ind_con;
				...
				IF @may_val>0
				BEGIN
					SELECT @want=ri_otr_ing FROM cxc_param_cnt WHERE llave=@ind_con;
		...
		BEGIN
			...
			BEGIN
				...
				SELECT @num_che=ISNULL(@num_che,'0');
				SELECT @bas_mov=ISNULL(@bas_mov,0);
				SELECT @wddc=che_deb FROM cxc_param_cnt WHERE llave=@ind_con;
				...
				INSERT INTO @cinfon (ano_doc,per_doc,sub_tip,tip_doc,num_doc,reg_doc,fch_doc,cod_cta,cod_suc,
								cod_cco,cod_cl1,cod_cl2,cod_cl3,cod_ter,deb_mov,cre_mov,des_mov,bas_mov,num_che,ind_cos,ind_tra,ind_mr,fec_tas,tasa,ind_tas,ind_adc)
				VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,@wreg,@fch_doc,@wddc,@cod_suc,
							CASE @i_cco WHEN 1 THEN @cod_cco ELSE '0' END,
							CASE @i_cl1 WHEN 1 THEN @cod_cl1 ELSE '0' END,
							CASE @i_cl2 WHEN 1 THEN @cod_cl2 ELSE '0' END,
							CASE @i_cl3 WHEN 1 THEN @cod_cl3 ELSE '0' END,
				...
				SET @wreg=@wreg+1;
				SELECT @wdcc=che_cre FROM cxc_param_cnt WHERE llave=@ind_con;
				...
				INSERT INTO @cinfon (ano_doc,per_doc,sub_tip,tip_doc,num_doc,reg_doc,fch_doc,cod_cta,cod_suc,
								...
								cod_ter,
								deb_mov,cre_mov,des_mov,bas_mov,num_che,ind_cos,ind_tra,ind_mr,fec_tas,tasa,ind_tas,ind_adc)
				VALUES (@ano_doc,@per_doc,@sub_tip,@tip_doc,@num_doc,@wreg,@fch_doc,@wdcc,@cod_suc,
							CASE @i_cco WHEN 1 THEN @cod_cco ELSE '0' END,
							CASE @i_cl1 WHEN 1 THEN @cod_cl1 ELSE '0' END,
							CASE @i_cl2 WHEN 1 THEN @cod_cl2 ELSE '0' END,
							CASE @i_cl3 WHEN 1 THEN @cod_cl3 ELSE '0' END,
		...
		BEGIN
			...
			BEGIN
				...
				BEGIN
					...
					SELECT @wddc=che_cre FROM cxc_param_cnt WHERE llave=@ind_con;
		...
		INSERT INTO cxc_inf_con(ano_doc,per_doc,sub_tip,tip_doc,num_doc,reg_doc,fch_doc,cod_suc,cod_cco,cod_cl1,cod_cl2,cod_cl3,cod_cta,cod_ter,
