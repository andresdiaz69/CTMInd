# Stored Procedure: MLC_consulta_empleados_retirados
...
CREATE procedure [dbo].[MLC_consulta_empleados_retirados] 
@año	int,
@mes	int
as
BEGIN
...
Nombre_Departamento_trabajo,Codigo_Ciudad_trabajo,Nombre_Ciudad_trabajo,Codigo_agrupador_Junta, Agrupador_Junta,Codigo_Tipo_Contrato,Nombre_Tipo_Contrato,
Fecha_Nacimiento,genero,Indicador_salario_variable,Indicador_comisiones,Prefijo_Cuenta_contable,Codigo_CNO,Descripcion_CNO,Codigo_clase_salario,Nombre_Clase_salario,
Fecha_retiro,Codigo_Causa_retiro,CausaRetiro=r.nom_ret,Documento=num_ide
from(
		...
		codigo_Cargo_Generico=b.cod_cl4,nombre_Cargo_Generico=g4.nombre,Codigo_Cargo=b.cod_car,Nombre_Cargo=r.nom_car,
		...
		Indicador_comisiones=b.cod_cl6,e.num_ide
		from rhh_emplea							e
