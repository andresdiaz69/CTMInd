# Stored Procedure: rs_gth_gth103_a_PE
...
-- Description:	Entrevista Candidato
-- =============================================

CREATE PROCEDURE [dbo].[rs_gth_gth103_a_PE]
	 @cod_cli		CHAR(15),
	 @cod_conv      VARCHAR(15),
	 @cod_resp		CHAR(12),
	 @num_req       INT,
...
BEGIN
	...
	WHERE	V.cod_cli LIKE RTRIM(@cod_cli) AND V.cod_conv LIKE RTRIM(@cod_conv)
			...
			AND V.cod_cli IS NOT NULL AND EEP.tip_ent = RTRIM(@tip_ent)
