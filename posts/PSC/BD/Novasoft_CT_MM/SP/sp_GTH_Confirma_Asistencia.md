# Stored Procedure: sp_GTH_Confirma_Asistencia
...
-- Description:	Proceso envio confirmación asistencia a un evento
-- ======================================================================
CREATE PROCEDURE [dbo].[sp_GTH_Confirma_Asistencia]
	@cod_ale	INT,
	@DTNuevo	XML, 
	@DTAnterior XML
...
BEGIN
	...
	SET @sMsg  = @sMsg + 'Queremos contarle que ha sido inscrito a la capacitación ' +  @nom_even ;	
