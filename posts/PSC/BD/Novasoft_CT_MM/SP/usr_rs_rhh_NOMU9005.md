# Stored Procedure: usr_rs_rhh_NOMU9005
...
-- =============================================
CREATE procedure [dbo].[usr_rs_rhh_NOMU9005]
		@cod_emp	char(12)	= '74374702',
		@fec_cer	datetime	=	'20181010',
...
--select @garantizado = case when fec_has < @fec_cer then 0 else 1 end from rhh_novfija where cod_emp = @cod_emp and cod_con = '100022'
