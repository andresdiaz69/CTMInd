...
CREATE VIEW [dbo].[v_cxc_chepos_flu]
AS
...
cab.fch_doc,CASE WHEN sal_doc=0 AND final IS NULL THEN 'C'
						...
						END  AS est_che,cue.fec_che,sal_doc,val_pag,cab.ano_doc,cab.per_doc,cab.sub_tip,cab.num_doc,reg_doc,fec_pag
