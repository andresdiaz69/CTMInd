...
SELECT     dbo.rhh_emplea.cod_emp, dbo.rhh_emplea.ap1_emp, dbo.rhh_emplea.ap2_emp, dbo.rhh_emplea.nom_emp, dbo.rhh_emplea.tip_ide, dbo.rhh_emplea.pai_exp, 
                      ...
                      ISNULL(dbo.rhh_emplea.cod_cl1,0) AS cod_cl1, ISNULL(dbo.rhh_emplea.cod_cl2,0) AS cod_cl2, ISNULL(dbo.rhh_emplea.cod_cl3,0) AS cod_cl3, ISNULL(dbo.rhh_emplea.cod_cl4,0) AS cod_cl4, 
					  ISNULL(dbo.rhh_emplea.cod_cl5,0) AS cod_cl5, ISNULL(dbo.rhh_emplea.cod_cl6,0) AS cod_cl6, ISNULL(dbo.rhh_emplea.cod_cl7,0) AS cod_cl7,
					  dbo.rhh_emplea.cod_car, dbo.rhh_emplea.tip_con, dbo.rhh_emplea.tip_pag, dbo.rhh_emplea.met_ret, dbo.rhh_emplea.por_ret, 
				  ...
				  dbo.rhh_emplea.ind_estlabref,dbo.rhh_emplea.cod_pagelec,dbo.rhh_emplea.gradodisc_ec,dbo.rhh_emplea.ind_ctt
