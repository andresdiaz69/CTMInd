...
FROM	CTT_cabdoc cab
INNER	JOIN CTT_cuedoc cue ON cab.ano_doc=cue.ano_doc AND cab.per_doc=cue.per_doc AND cab.sub_tip=cue.sub_tip AND cab.num_doc=cue.num_doc
LEFT	JOIN v_ctt_emplea emp ON emp.cod_emp=cab.cod_emp
LEFT	JOIN v_ctt_emplea emp1 ON emp1.cod_emp=cue.cod_emp
LEFT	JOIN v_ctt_concep con ON con.cod_con=cab.cod_con
LEFT	JOIN v_ctt_concep con1 ON con1.cod_con=cue.cod_con
