# View: v_nom_sapwebserviceActioByte
...
CREATE VIEW [dbo].[v_nom_sapwebserviceActioByte]
AS
	--
	SELECT 
	--CABECERA
	...
	'' AS 'zSetOfBooksIDZ',
	0 AS 'zAccountingEntryThirdPartyIndicator',
	0 AS 'zThirdPartyID',
	...
	GROUP BY ano_doc, per_doc,sub_tip,num_doc,cod_cia, cod_cl1,fch_doc,fch_doc,des_mov,
