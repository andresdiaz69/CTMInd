# View: v_inv_analisis_pres_grupo
...
CREATE VIEW [dbo].[v_inv_analisis_pres_grupo]
AS
SELECT vis.ano_acu, vis.per_acu, cod_grupo, nom_gru, ISNULL(SUM(pre_uni),0) AS pre_uni, ISNULL(SUM(pre_val),0) AS pre_val,
...
GROUP BY vis.ano_acu, vis.per_acu, cod_grupo, nom_gru
