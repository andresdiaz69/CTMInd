...
```sql
create view [dbo].[vw_Presupuestos_Bonos] as
--****************************
--Autor: Manuel Suarez
-- Date: 18/07/2024
--Descr: Create VW para proyecto presupuestos con los bonos de alimentacion asignado por la empresa.
--****************************
select distinct cod_emp,nombres,Codigo_Cargo,Nombre_Cargo,Codigo_Cargo_Generico,Nombre_Cargo_generico,
  ...
  from (
		select distinct cod_emp,nombres,Codigo_Cargo,  Nombre_Cargo,Codigo_Cargo_Generico,Nombre_Cargo_generico,
		  ...
		  from (
				select be.cod_emp,nombres =isnull(e.nom1_emp,'')+' '+isnull(e.nom2_emp,'')+' '+isnull(e.ap1_emp,'')+' '+isnull(e.ap2_emp,''),
				  ...
				  left join	[Novasoft_CT_MM].dbo.gen_sucursal			s	on b.cod_suc=s.cod_suc 
				  ...
				  left join	[Novasoft_CT_MM].dbo.gen_compania			i	on i.cod_cia=b.cod_cia	
																		   and b.cod_emp = e.cod_emp
																		   and b.cod_cia = e.cod_cia
				  left join	[Novasoft_CT_MM].dbo.gen_ccosto				o	on o.cod_cco = b.cod_cco
																		   and b.cod_emp = e.cod_emp
																		   and b.cod_cia = e.cod_cia
      ...
      ) b group by cod_emp,nombres,Codigo_Cargo,Nombre_Cargo,Codigo_Cargo_Generico,Nombre_Cargo_generico,Codigo_Compañia,Nombre_Compañia,
			    codigo_marca,nombre_marca,codigo_centro,nombre_centro
