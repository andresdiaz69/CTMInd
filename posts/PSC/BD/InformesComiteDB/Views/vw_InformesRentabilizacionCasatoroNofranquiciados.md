# View: vw_InformesRentabilizacionCasatoroNofranquiciados
...
CREATE VIEW [dbo].[vw_InformesRentabilizacionCasatoroNofranquiciados]
AS
...
FROM            (SELECT        CodigoPresentacion, NombrePresentacion, Año, NombreConcepto, AcumuladoP, Acumulado, Diciembre, DiciembreP, Orden
                          ...
                          WHERE        (CodigoPresentacion IN
                                                        (SELECT        CodigoPresentacion
                                                          ...
                                                          WHERE        (IndRentaTipo = 'NoFranquiciados') AND (EmpresaPrincipal = 1)))) AS a
