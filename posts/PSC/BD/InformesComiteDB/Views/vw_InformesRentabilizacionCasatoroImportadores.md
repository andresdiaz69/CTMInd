# View: vw_InformesRentabilizacionCasatoroImportadores
...
CREATE VIEW [dbo].[vw_InformesRentabilizacionCasatoroImportadores]
AS
...
FROM            (SELECT        CodigoPresentacion, NombrePresentacion, Año, NombreConcepto, AcumuladoP, Acumulado, Diciembre, DiciembreP, Orden
                          ...
                          WHERE        (CodigoPresentacion IN
                                                        (SELECT        CodigoPresentacion
                                                          ...
                                                          WHERE        (IndRentaTipo = 'Importadores') AND (EmpresaPrincipal = 1)))) AS a
