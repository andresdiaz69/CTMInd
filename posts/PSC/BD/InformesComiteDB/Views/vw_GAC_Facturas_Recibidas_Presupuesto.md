# View: vw_GAC_Facturas_Recibidas_Presupuesto
...
-- Date: 17/10/2024
--Descr: Create VW para proyecto presupuesto. Generera el calculo de Facturas recibidas para GAC.
...
where Ano_Periodo=(SELECT DATEPART(YY,GETDATE()))
