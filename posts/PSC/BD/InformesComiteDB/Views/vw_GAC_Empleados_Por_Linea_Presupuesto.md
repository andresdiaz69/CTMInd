# View: vw_GAC_Empleados_Por_Linea_Presupuesto

## Usa los objetos:
- [[vw_GAC_Base_Empleados_Linea_Presupuesto]]
...
-- Date: 17/10/2024
--Descr: Create VW para proyecto presupuesto. Generera el calculo de personas para GAC.
--Se replica de las vista de la base DBMLC_0190
--****************************

CREATE VIEW [dbo].[vw_GAC_Empleados_Por_Linea_Presupuesto] AS 
select bb.Ano, 
       bb.trimestre,
	   CodUnidadNegocio, 	    
	   bb.Linea,
  ...
  from (select Ano,     trimestre,	   CodUnidadNegocio, 	    
          ...
          from (SELECT Ano=Ano_Periodo, 
                  ...
                  FROM vw_GAC_Base_Empleados_Linea_Presupuesto A 
