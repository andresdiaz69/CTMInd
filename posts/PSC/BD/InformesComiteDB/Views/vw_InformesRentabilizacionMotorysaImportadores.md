# View: vw_InformesRentabilizacionMotorysaImportadores
...
CREATE VIEW [dbo].[vw_InformesRentabilizacionMotorysaImportadores]
AS
SELECT        'Importadores' AS NombrePresentacion, Año, NombreConcepto, 'Acumulado a Diciembre' AS Titulo1, SUM(AcumuladoP) AS Presupuesto1, SUM(Acumulado) 
...
FROM            (SELECT        CodigoPresentacion, NombrePresentacion, Año, NombreConcepto, AcumuladoP, Acumulado, Diciembre, DiciembreP, Orden
                          ...
                          WHERE        (CodigoPresentacion IN
                                                        (SELECT        CodigoPresentacion
                                                          ...
                                                          WHERE        (IndRentaTipo = 'Importadores') AND (EmpresaPrincipal = 6)))) AS a
