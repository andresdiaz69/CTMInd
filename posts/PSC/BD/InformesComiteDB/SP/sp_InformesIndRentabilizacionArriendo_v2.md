# Stored Procedure: sp_InformesIndRentabilizacionArriendo_v2
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_InformesIndRentabilizacionArriendo_v2]
...
BEGIN
	...
	from 
		...
		from InformesIndRentabilizacion_v2   
		...
		left join
		InformesIndMetas h on a.CodigoPresentacion = h.CodigoPresentacion and Indicador = @Indicador and h.Año = @Año
		left join
