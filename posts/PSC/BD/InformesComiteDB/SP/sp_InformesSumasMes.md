# Stored Procedure: sp_InformesSumasMes
...
-- Create date: 2018
-- Description:	Suma las presentaciones (Detalle Anterior y Actual) a diferencia del sp_InformesSumas aca se suma la comulna de presupuesto por que no es presupuesto.
-- =============================================
CREATE PROCEDURE [dbo].[sp_InformesSumasMes]
...
--------VERSION 2-----------------------------------------------------------------
			...
			update #TablaTemporal1 set 
				Anterior =  
				(select sum(Anterior) from #TablaTemporal1 where (Nivel1 = 100 and Nivel2=400 and Nivel3 =200 and Nivel4 =100)) - 
				(select sum(Anterior) from #TablaTemporal1 where (Nivel1 = 200 and Nivel2=200 and Nivel3 =100 and Nivel4 =100)), 
				Actual =  
				(select sum(Actual) from #TablaTemporal1 where (Nivel1 = 100 and Nivel2=400 and Nivel3 =200 and Nivel4 =100)) - 
				(select sum(Actual) from #TablaTemporal1 where (Nivel1 = 200 and Nivel2=200 and Nivel3 =100 and Nivel4 =100))
				,Presupuesto =  
				(select sum(Presupuesto) from #TablaTemporal1 where (Nivel1 = 100 and Nivel2=400 and Nivel3 =200 and Nivel4 =100)) - 
				(select sum(Presupuesto) from #TablaTemporal1 where (Nivel1 = 200 and Nivel2=200 and Nivel3 =100 and Nivel4 =100))
				where Nivel1 = 200 and Nivel2=200 and Nivel3 =100 and Nivel4 =0 

			-- Utilidad Bruta vehículos Demo
			update #TablaTemporal1 set 
				Anterior =  
				(select sum(Anterior) from #TablaTemporal1 where (Nivel1 = 100 and Nivel2=400 and Nivel3 =200 and Nivel4 =200)) - 
				(select sum(Anterior) from #TablaTemporal1 where (Nivel1 = 200 and Nivel2=200 and Nivel3 =200 and Nivel4 =100)), 
				Actual =  
				(select sum(Actual) from #TablaTemporal1 where (Nivel1 = 100 and Nivel2=400 and Nivel3 =200 and Nivel4 =200)) - 
				(select sum(Actual) from #TablaTemporal1 where (Nivel1 = 200 and Nivel2=200 and Nivel3 =200 and Nivel4 =100))
				,Presupuesto =  
				(select sum(Presupuesto) from #TablaTemporal1 where (Nivel1 = 100 and Nivel2=400 and Nivel3 =200 and Nivel4 =200)) - 
				(select sum(Presupuesto) from #TablaTemporal1 where (Nivel1 = 200 and Nivel2=200 and Nivel3 =200 and Nivel4 =100))
				where Nivel1 = 200 and Nivel2=200 and Nivel3 =200 and Nivel4 =0 

			-- Utilidad Bruta vehículos Fuera de estandar
			update #TablaTemporal1 set 
				Anterior =  
				(select sum(Anterior) from #TablaTemporal1 where (Nivel1 = 100 and Nivel2=400 and Nivel3 =200 and Nivel4 =300)) - 
				(select sum(Anterior) from #TablaTemporal1 where (Nivel1 = 200 and Nivel2=200 and Nivel3 =300 and Nivel4 =100)), 
				Actual =  
				(select sum(Actual)   from #TablaTemporal1 where (Nivel1 = 100 and Nivel2=400 and Nivel3 =200 and Nivel4 =300)) - 
				(select sum(Actual)   from #TablaTemporal1 where (Nivel1 = 200 and Nivel2=200 and Nivel3 =300 and Nivel4 =100))
				,Presupuesto =  
				(select sum(Presupuesto)   from #TablaTemporal1 where (Nivel1 = 100 and Nivel2=400 and Nivel3 =200 and Nivel4 =300)) - 
				(select sum(Presupuesto)   from #TablaTemporal1 where (Nivel1 = 200 and Nivel2=200 and Nivel3 =300 and Nivel4 =100))
...
-------------------------------------------------------------------------
		...
		------Mano de Obra -------------------------------------------------------------------
			...
			update #TablaTemporal1 set 
				...
				(select sum(Presupuesto)   from #TablaTemporal1 where (Nivel1 = 200 and Nivel2=400 and Nivel3 =200 and Nivel4=0 )) 
