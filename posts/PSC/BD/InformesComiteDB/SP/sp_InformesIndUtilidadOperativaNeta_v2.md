# Stored Procedure: sp_InformesIndUtilidadOperativaNeta_v2

## Usa los objetos:
- [[InformesDefinitivos]]
- [[InformesIndUtilidadOperativaNeta_v2]]
- [[InformesMeses]]
...
CREATE PROCEDURE [dbo].[sp_InformesIndUtilidadOperativaNeta_v2] 
...
BEGIN
	...
	IF OBJECT_ID (N'dbo.InformesIndUtilidadOperativaNeta', N'U') IS NOT NULL
		DELETE FROM InformesIndUtilidadOperativaNeta_v2 WHERE Año = @Año

	IF OBJECT_ID (N'dbo.InformesIndUtilidadOperativaNeta', N'U') IS NULL 
	BEGIN
		CREATE TABLE [dbo].[InformesIndUtilidadOperativaNeta_v2](
			[Año] [int] NULL,
			[Mes] [smallint] NULL,
	...
	insert into InformesIndUtilidadOperativaNeta_v2 ([Año],[Mes],[NombreMes],[Sede],[Utilidad],[Ingresos],[Indicador],[Orden])
