# Stored Procedure: sp_InformesIndRentabilizacionXTipo_v2

## Usa los objetos:
- [[InformesIndRentabilizacion_v2]]
- [[InformesIndRentabilizacionXTipo_v2]]
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_InformesIndRentabilizacionXTipo_v2]
...
BEGIN
	...
	select case when @TipoNombre = '' then 'Total' else @TipoNombre end NombrePresentacion,Año,@Mes Mes,@Empresa Empresa,@Tipo Tipo,NombreConcepto,'Acumulado a '+
	case
	...
	from InformesIndRentabilizacion_v2 r 
	...
	--tbltmep
	IF OBJECT_ID (N'dbo.InformesIndRentabilizacionXTipo', N'U') IS NULL
		select * into InformesIndRentabilizacionXTipo_v2 from #TmpInformesIndRentabilizacion
	
	delete from InformesIndRentabilizacionXTipo_v2 where Año = @Año and Mes = @Mes and Empresa=@Empresa and Tipo = @Tipo 

	insert into InformesIndRentabilizacionXTipo_v2
		select *,getdate() from #TmpInformesIndRentabilizacion

	select * from InformesIndRentabilizacionXTipo_v2 where Año = @Año and Mes = @Mes and Empresa=@Empresa and Tipo = @Tipo 
