# Stored Procedure: sp_InformesIndRentabilizacionArriendos
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_InformesIndRentabilizacionArriendos]
...
BEGIN
	...
	from
		...
		from InformesIndRentabilizacion a 
		where Año = @Año-1 and Orden = 93
		) t1 		
		on t1.CodigoPresentacion = t2.CodigoPresentacion and t1.Año=t2.Año-1 
	...
	--select Acum_Anterior,Mes,NombrePresentacion,Acum_Actual,Acum_Presupuesto,case when Acum_Presupuesto<>0 then (Acum_Actual-Acum_Presupuesto)/Acum_Presupuesto else 0 end Meta,IndRentaTipo,t1.Año AñoAnterior,t2.Año AñoActual,EmpresaPrincipal
	--from
	--	(select   
	--		case 
	--			when @Mes=1 then Enero
	...
	--		end Acum_Presupuesto, 		
	--		0 Meta,
	--		Orden, a.CodigoPresentacion,b.EmpresaPrincipal,Año
	--	from InformesIndRentabilizacion a left join InformesPresentaciones b on a.CodigoPresentacion = b.CodigoPresentacion 
	--	where Orden = 93 
	--	) t2 left join
	...
	--			when @Mes=11 then Enero+Febrero+Marzo+Abril+Mayo+Junio+Julio+Agosto+Septiembre+Octubre+Noviembre
	--			when @Mes=12 then Enero+Febrero+Marzo+Abril+Mayo+Junio+Julio+Agosto+Septiembre+Octubre+Noviembre+Diciembre
	--		end Acum_Anterior, Orden, a.CodigoPresentacion,b.IndRentaTipo,b.IndRentaOrden,Año
	--	from InformesIndRentabilizacion a left join InformesPresentaciones b on a.CodigoPresentacion = b.CodigoPresentacion 
	--	where Año = @Año-1 and Orden = 93
	--	) t1 
