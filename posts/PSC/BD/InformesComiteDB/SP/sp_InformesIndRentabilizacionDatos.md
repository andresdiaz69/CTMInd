# Stored Procedure: sp_InformesIndRentabilizacionDatos
...
CREATE PROCEDURE [dbo].[sp_InformesIndRentabilizacionDatos]
...
-- Verifica la tabla resultado
		...
		IF OBJECT_ID (N'dbo.InformesIndRentabilizacion', N'U') IS NOT NULL
		begin
			delete from dbo.InformesIndRentabilizacion where año = @Año
			insert into dbo.InformesIndRentabilizacion select * from #TablaIndRentabilizacion
		end
		else
		begin
			select * into dbo.InformesIndRentabilizacion from #TablaIndRentabilizacion
		end
...
-- Selecciona datos Finales
		...
		Select *
		from InformesIndRentabilizacion where Año = @Año
