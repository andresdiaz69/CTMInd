# Stored Procedure: sp_Presupuestos_FacturacionVN_PorCentro
...
CREATE PROCEDURE [dbo].[sp_Presupuestos_FacturacionVN_PorCentro]
...
-- =============================================
-- Control de Cambios
-- 2024|08|15 - Wilder Chacón - Creado para Listar Facturacion vn y calcular valores por mes
-- 2024|10|09 - Manuel Suarez - Alter SP donde se agrega filtro para poder consultar las diferentes clases y no solo base.
...
--declare	@idClase      SMALLINT = 1;
	...
	SET @QParticipacionCentro = (
		...
		SELECT valor 
		 ...
		 WHERE vpc.IdTipo     = 120 -- '% Participación Centro' 
		   AND IdSubCategoria = 15 -- 'Vehiculos Nuevos' 
 ...
 SELECT 
		a.Ano_Periodo,	                                a.CodigoLinea,								                a.NombreLinea,		
