# Stored Procedure: sp_InformesIndRentabilizacionUtilidad_v2
...
CREATE PROCEDURE [dbo].[sp_InformesIndRentabilizacionUtilidad_v2]
...
BEGIN
	...
	from
		...
		from InformesIndRentabilizacion_v2 a 
