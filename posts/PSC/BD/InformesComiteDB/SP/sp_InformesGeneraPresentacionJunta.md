# Stored Procedure: sp_InformesGeneraPresentacionJunta
...
-- 2020-05-26 : Se agrega el margen Ebitda al cuadro Ebitda
-- Se modifican colores según solicitud
-- =======================================================================================================================================

CREATE PROCEDURE [dbo].[sp_InformesGeneraPresentacionJunta] 
...
BEGIN	
	...
	BEGIN TRY 
		...
		-- AGREGA CUADROS JUNTA BALANCE MES+ACU
			...
			PRINT 'RETORNA TABLA'
			select @CodigoPresentacion CodigoPresentacion,@Año Año,@Mes Mes,* into TablaJunta from #TablaJunta order by CodigoPresentacion,Tipo,CodigoCuadro,Renglon
